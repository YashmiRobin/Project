...
<body background="D:\eclipse\addcustomer.jpg">
<p>Enter the customer details to add</p>
<form action="#"method="GET">
            <table>
                    ...
                    <tr>
                        ...
                        <td> 
                            <input id="phnoip" name="uphno" type="text" required>
                        </td>
                    </tr>
                    <tr>
                        <td><font size="3" color="white"> Email: </font></td>
                        <td> 
                            <input id="emailip" name="uemail" type="text" required>
                        </td>
                    </tr>
                    <tr>
                        <td><font size="3" color="white"> Address: </font></td>
                        <td> 
                            <input id="addressip" name="uaddress" type="text" required>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td> &nbsp; </td>
                        <td> 
                            <button id="Add" formaction="AddMsg.jsp" type="submit">Add</button>
                        </td>
                    </tr>
                </table>
